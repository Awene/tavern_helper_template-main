    ...
    children: [
      {
        id: 'eco-nj',
        name: '南疆',
        description: '湿热雨林与十万大山纵横，蛊毒之乡；五毒教、幽冥府、万兽宗各据一隅。',
        tags: ['湿热', '蛊毒', '妖族'],
        kingdoms: [
          {
            name: '万妖盟',
            brief: '居十万大山，众妖联盟，鲜少入世。',
            tags: ['妖族'],
          },
        ],
        sects: [
          { name: '五毒教', brief: '魔道宗门，修毒蛊之术，居雨瘴林。', tags: ['魔道', '蛊毒'] },
          { name: '幽冥府', brief: '掌死气、驱尸傀之魔道宗门，居永恒谷。', tags: ['魔道', '亡灵'] },
          { name: '万兽宗', brief: '正道宗门，善驯灵兽并能与之偕战，居翠玉丘。', tags: ['正道', '驭兽'] },
        ],
      },
    ],
  },
