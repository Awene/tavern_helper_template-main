...
const CultivationArtSchema = z.object({
  ...
  类型: z.enum(['心法', '攻击', '幻术', '神识', '咒法', '身法', '护体', '其他']).prefault('心法'),
...
const ItemSchema = z.object({
  ...
  类型: z.enum(['秘籍', '配方', '符箓', '丹药', '素材', '工具', '其他']).prefault('其他'),
  消耗: z.string().optional(),
  五行: FiveElementsEnum.optional(),
  标签: z.array(z.string()).prefault([]),
  数量: z.coerce
...
export const CultivationStatusSchema = z.object({
  基本信息: BasicInfoSchema.prefault({
    ...
    体质: { 名称: '凡体', 悟性: 0, 根骨: 0, 气感: 0 },
    修炼进度: { 境界: '凡人', 当前进度: 0, 进度上限: 100, 天谴: 0 },
    技艺: { 生产类: {}, 战斗类: {} },
    资源池: { 气血: { 现值: 100, 上限: 100 }, 灵力: { 现值: 100, 上限: 100 }, 遁速: 10 },
